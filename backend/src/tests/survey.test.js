...
describe('Survey tests', () => {
  it(
    "It shouldn't be possible to do the search without a 'name'",
    async () => {
  ...
  it(
    "It shouldn't be possible to do the search without a 'email'",
    async () => {
      const response = await request(app)
        .post('/survey')
        .send({
  ...
  it(
    "It shouldn't be possible to do the search without a valid 'email'",
    async () => {
      const response = await request(app)
        .post('/survey')
        .send({
  ...
  it(
    "It shouldn't be possible to do the search without a number value",
    async () => {
      const response = await request(app)
        .post('/survey')
        .send({
  ...
  it(
    "It shouldn't be possible to do the search without a numeric value less than 10 or equal to 10",
    async () => {
      const response = await request(app)
        .post('/survey')
        .send({
